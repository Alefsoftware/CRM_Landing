...
@Component({
    ...
    imports: [RouterLink, NavbarStyleTwoComponent, FeaturesStyleOneComponent, FeaturesStyleFourComponent, DownloadAppStyleOneComponent, FooterStyleFourComponent, BackToTopComponent],
